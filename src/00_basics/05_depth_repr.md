...
> [!NOTE]
> **预计阅读时间**：35 分钟 · **前置知识**：本篇第 01 节（相机模型）、第 02 节（坐标系转换）、第 04 节（多视图几何入门）
>
...
### 5.1.5 Mini Case：加载一张深度图，用热力图和点云两种方式看它
...
### 5.2.5 Code Lens：深度图与点云的 NumPy 互转
...
- 本书内：[[02 坐标系转换]] · [[04 多视图几何入门]] · [[06 优化基础]]
