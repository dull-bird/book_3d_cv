...
> **一句话**：相机模型讲的是"图像怎么来的"，这一章讲的是"深度怎么来的"——不同的 3D 传感技术在测距原理、精度、成本和适用场景上有本质差异，选错传感器的代价远大于选错算法。

## 概述

3D 视觉的起点是获取场景的三维信息。人眼通过双目视差感知深度，机器则有更多选择：主动投射红外光斑、发射激光脉冲、旋转扫描、甚至靠单帧照片推断距离。
